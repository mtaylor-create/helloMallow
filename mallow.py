...
def freshFace(pText):
    try:
        pText.RemoveText("eyes")
        pText.AddText("o ‿ o",10,10,60,Id="eyes")

    except:
        pText.AddText("o ‿ o",10,10,60,Id="eyes")

def defaultFace(pText):
    pText.UpdateText("eyes","o ‿ o")

def muhFace(pText):
    pText.UpdateText("eyes","o _ o")

def flatFace(pText):
    pText.UpdateText("eyes",".___.")

def vampireFace(pText):
    pText.UpdateText("eyes","o w o")

def asleepFace(pText):
    pText.UpdateText("eyes","◡ ‿ ◡")

def wowFace(pText):
    pText.UpdateText("eyes","◕ . ◕")

def sillyFace(pText):
    pText.UpdateText("eyes","◔ ◡ ◔")

def awwFace(pText):
    pText.UpdateText("eyes","◜ _ ◝")

def loveFace(pText):
    pText.UpdateText("eyes","♥ ‿ ♥")


face=PapirusTextPos(rotation=180)
face.partialUpdates=True
freshFace(face)
asleepFace(face)
